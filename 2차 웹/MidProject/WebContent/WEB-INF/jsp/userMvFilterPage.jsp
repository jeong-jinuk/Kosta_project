    ...
    <section id="main-content">
      ...
      <div class="showback" style="text-align:center ">
              ...
              <label class="checkbox-inline"> <!-- 장르 필터목록은 고정되어 있는 값이므로 하드코딩으로 일단... -->
                <input type="checkbox" class="chkbox" id="mvFilterChkb1" value="C0000010"> 액션
                </label>
              <label class="checkbox-inline">
                <input type="checkbox" class="chkbox" id="mvFilterChkb2" value="C0000019"> SF
                </label>
              <label class="checkbox-inline">
                ...
                <label class="checkbox-inline">
                <input type="checkbox" class="chkbox" id="mvFilterChkb5" value="C0000001"> 다큐멘터리
                </label>
               ...
               <div style="text-align:center">
               		<button type="button" id="saveBtn" class="btn btn-primary"  style="width:200px" >
               		저장
               		</button>
