				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu"><a href="javascript:;">
						...
						<ul class="sub">
							...
							<li><a href="advanced_table.html">Advanced
									Table</a></li>
						</ul></li>
        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 영화 판매 로그
				</h3>
				<div class="row mb">
					<!-- page start-->
							...
							<table id="example" class="display" style="width: 100%">
								...
								<tbody>
									<c:forEach var="e" items="${slist }">
										<tr>
											<td class="no">${e.soldlog_number}</td>
											<td>&nbsp;&nbsp;${e.member_number }</td>
											<td>&nbsp;&nbsp;${e.movie_number }</td>
											<td>&nbsp;&nbsp;${e.movie_price }</td>
											<td>&nbsp;&nbsp;${e.movie_sold_date }</td>
										</tr>
									</c:forEach>
								</tbody>
