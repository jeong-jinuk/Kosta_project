				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu"><a class="active" href="javascript:;">
						...
						<ul class="sub">
							...
							<li class="active"><a href="login_log.html">로그인 로그</a></li>
						</ul></li>
        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i> 로그인 로그
				</h3>
				<div class="row mb">
					<!-- page start-->
							...
							<table id="example" class="display" style="width: 100%">
								...
								<tbody>
									<c:forEach var="e" items="${slist }">
										<tr>
											<td class="no">${e.loginlog_number}</td>
											<td>&nbsp;&nbsp;${e.member_number }</td>
											<td>&nbsp;&nbsp;${e.loginlog_login }</td>
											<td>&nbsp;&nbsp;${e.loginlog_logout }</td>
										</tr>
									</c:forEach>
								</tbody>
